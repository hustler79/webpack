    ...
    <script type="text/babel">
        ...
        var TodoList = React.createClass({
            ...
            handleAdd: function() {
                ...
                var newItems = this.state.items.concat(['div '+this.i]);
                ...
                return (
                    <div>
                        ...
                        <React.addons.CSSTransitionGroup
                            ...
                            transitionEnterTimeout={6500} // transitionEnter={false} // to disable
                            transitionLeaveTimeout={6300}>
                            {items}
                        </React.addons.CSSTransitionGroup>
                    </div>
                );
        ...
        var Div = React.createClass({
            // these events are present in React.addons.TransitionGroup
